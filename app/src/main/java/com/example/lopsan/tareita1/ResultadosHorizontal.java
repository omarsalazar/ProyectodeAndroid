...
public class ResultadosHorizontal extends Fragment {
    ...
    protected void lanzarMenuOption1() {
        Intent intento;
        intento = new Intent(ResultadosHorizontal.this.getActivity(), Main3Activity.class);
        this.startActivity(intento);
    }

    protected void lanzarMenuOption2() {
        Intent intento;
        intento = new Intent(ResultadosHorizontal.this.getActivity(), Main4Activity.class);
        this.startActivity(intento);
    }
    protected void lanzarMenuOption3() {
        Intent intento;
        intento = new Intent(ResultadosHorizontal.this.getActivity(), Main5Activity.class);
        this.startActivity(intento);
    }
